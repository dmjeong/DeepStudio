...
데스크톱은 소스 ZIP만 배포합니다. 기존 Python 환경은 gui/requirements.txt를 다시 설치하거나 python -m pip install truststore==0.10.4 certifi 실행 후 스튜디오를 재시작하세요.
